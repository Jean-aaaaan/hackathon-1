...
SYNTH = [
    {
        "id": "seed-call-2",
        "title": "Abu Dhabi Municipality x Acme Corp — proposal walkthrough",
        "date": NOW_MS - 9 * DAY_MS,
        "duration": 2400,
        "organizer_email": "rep@acmecorp.com",
        "participants": ["rep@acmecorp.com", "arjun@tenderd.com"],
        "meeting_attendees": [
        ...
        "summary": {
            "overview": "Walked through the proposal. Arjun raised budget timing and asked who signs off on procurement. No economic buyer present.",
            "keywords": ["proposal", "budget", "procurement"],
            "action_items": [
                "**Alex** Send ISO 27001 certification pack (18:21)",
                "**Arjun** Confirm the ADM procurement contact by next week (31:05)",
                "**Arjun** Share internal budget timeline (33:40)",
            ],
        },
        "sentences": [
            {"speaker_name": "Alex Johnson", "text": "Let me walk through the deployment phases.", "start_time": 0, "end_time": 300},
            {"speaker_name": "Alex Johnson", "text": "Phase one covers the first forty cameras.", "start_time": 300, "end_time": 700},
            {"speaker_name": "Arjun Patel", "text": "Who would handle the on-site maintenance during the pilot?", "start_time": 700, "end_time": 760},
            {"speaker_name": "Alex Johnson", "text": "We provide that with a local partner.", "start_time": 760, "end_time": 900},
            ...
            {"speaker_name": "Alex Johnson", "text": "We have done Ministry approvals in KSA, similar flow.", "start_time": 980, "end_time": 1200},
        ],
    },
    {
        "id": "seed-call-1",
        ...
        "duration": 1800,
        "organizer_email": "rep@acmecorp.com",
        "participants": ["rep@acmecorp.com", "arjun@tenderd.com", "site.lead@tenderd.com"],
        "meeting_attendees": [
            {"displayName": "Alex Johnson", "email": "rep@acmecorp.com"},
            {"displayName": "Arjun Patel", "email": "arjun@tenderd.com"},
        ...
        "summary": {
            ...
            "action_items": [
                "**Alex** Send case study from KSA NOC deployment (40:12)",
            ],
        },
        "sentences": [
            {"speaker_name": "Alex Johnson", "text": "Tell me about the current safety setup.", "start_time": 0, "end_time": 100},
            ...
            {"speaker_name": "Alex Johnson", "text": "Yes, our models are trained on industrial night footage.", "start_time": 470, "end_time": 900},
        ],
    },
]
