...
import {
  ...
  AlertTriangle, Clock, X, ExternalLink, BarChart3, BookOpen,
} from "lucide-react";
...
const FORECAST_STYLES: Record<string, string> = {
  ...
  Omit: "bg-zinc-100 text-zinc-500 border-zinc-200",
};
    ...
    <div className="flex-1 flex flex-col min-h-0">
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          {/* Prompt banner */}
          <div className="card border-l-4 border-l-zinc-900 px-6 py-5">
            <div className="flex items-start justify-between gap-4 flex-wrap">
              ...
              <div className="flex flex-col sm:flex-row gap-2 flex-shrink-0">
                <Link
                  href={warRoomHref}
                  className="btn-accent inline-flex items-center justify-center gap-2 px-5 py-2.5"
                >
                  Open War Room
            ...
            <>
              ...
              {narrative && (
                <div className="card p-5">
                  <div className="flex items-center gap-2 mb-3">
                    <p className="section-header">Deal story</p>
                  </div>
              ...
              {hasMeddpicc && (
                <div className="card p-5">
                  ...
                  <Link
                    href={warRoomHref}
                    className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-zinc-600 hover:text-zinc-900"
                  >
  ...
  return (
    <div className="h-full flex items-center justify-center bg-zinc-50 px-6">
      <div className="text-center max-w-md">
        <div className="w-12 h-12 bg-zinc-100 rounded-2xl mx-auto mb-4 flex items-center justify-center">
